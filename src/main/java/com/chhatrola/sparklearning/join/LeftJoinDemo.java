...
public class LeftJoinDemo {
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("LeftJoinDemo").setMaster("local[*]");
        ...
        JavaPairRDD<Integer, Tuple2<String, Optional<Integer>>> userDataVisitJoinRdd = userDataPairRdd.leftOuterJoin(userVisitPairRdd);
