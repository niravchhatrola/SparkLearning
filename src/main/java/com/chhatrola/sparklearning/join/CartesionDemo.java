...
public class CartesionDemo {
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("CartesionDemo").setMaster("local[*]");
        ...
        JavaPairRDD<Tuple2<Integer, String>, Tuple2<Integer, Integer>> cartesian = userDataPairRdd.cartesian(userVisitPairRdd);
