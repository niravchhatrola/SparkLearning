...
public class FullJoinDemo {
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("FullJoinDemo").setMaster("local[*]");
        ...
        JavaPairRDD<Integer, Tuple2<Optional<String>, Optional<Integer>>> userDataVisitJoinRdd = userDataPairRdd.fullOuterJoin(userVisitPairRdd);
