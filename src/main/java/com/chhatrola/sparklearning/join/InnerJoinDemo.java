...
public class InnerJoinDemo {
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("InnerJoinDemo").setMaster("local[*]");
        ...
        JavaPairRDD<Integer, Tuple2<String, Integer>> userDataVisitPairRdd= userDataPairRdd.join(userVisitPairRdd);


        userDataVisitPairRdd.collect().forEach(System.out::println);
