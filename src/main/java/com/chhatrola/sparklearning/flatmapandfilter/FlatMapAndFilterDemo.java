 ...
 */
public class FlatMapAndFilterDemo {
    ...
    public static void main(String[] args) {
        ...
        JavaRDD<String> flatRdd = inputData.flatMap(val -> Arrays.asList(val.split(" ")).iterator());
        JavaRDD<String> filterRdd = flatRdd.filter(val -> val.length() > 1);
